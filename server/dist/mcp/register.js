...
function registerResources(server) {
    ...
    server.registerResource("Submission Intake Playbook", submissionPlaybookResourceUri, {
...
function registerPrompts(server) {
    server.prompt("upload_submission", "Use after attaching a broker submission file. Classifies the uploaded document and recommends whether to process it.", () => ({
    ...
    server.prompt("extract_submission", "Extract structured submission data from the uploaded broker submission.", () => ({
    ...
    server.prompt("create_quote", "Create a quote from the extracted submission and show the embedded quote record UI.", () => ({
